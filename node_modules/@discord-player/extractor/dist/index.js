...
async function loadYtdl(options) {
...
var _YoutubeExtractor = class extends import_discord_player2.BaseExtractor {
  ...
  async validate(query, type) {
    if (typeof query !== "string")
      return false;
    return [import_discord_player2.QueryType.YOUTUBE, import_discord_player2.QueryType.YOUTUBE_PLAYLIST, import_discord_player2.QueryType.YOUTUBE_SEARCH, import_discord_player2.QueryType.YOUTUBE_VIDEO, import_discord_player2.QueryType.AUTO].some((r) => r === type);
  }
  async handle(query, context) {
    ...
    switch (context.type) {
      case import_discord_player2.QueryType.YOUTUBE_PLAYLIST: {
        ...
        playlist.tracks = ytpl.videos.map(
          (video) => new import_discord_player2.Track(this.context.player, {
            title: video.title,
      ...
      case import_discord_player2.QueryType.YOUTUBE_VIDEO: {
        ...
        return {
          playlist: null,
          tracks: [
            new import_discord_player2.Track(this.context.player, {
              title: video.title,
              description: video.description,
              author: video.channel?.name,
              url: video.url,
...
var AppleMusicExtractor = class extends import_discord_player7.BaseExtractor {
  ...
  async validate(query, type) {
    return [import_discord_player7.QueryType.APPLE_MUSIC_ALBUM, import_discord_player7.QueryType.APPLE_MUSIC_PLAYLIST, import_discord_player7.QueryType.APPLE_MUSIC_SONG, import_discord_player7.QueryType.APPLE_MUSIC_SEARCH].some((t) => t === type);
  }
  async handle(query, context) {
    switch (context.type) {
      case import_discord_player7.QueryType.APPLE_MUSIC_SEARCH: {
        ...
        const tracks = data.map(
          (m) => new import_discord_player7.Track(this.context.player, {
...
var SpotifyExtractor = class extends import_discord_player8.BaseExtractor {
  ...
  async validate(query, type) {
    return [import_discord_player8.QueryType.SPOTIFY_ALBUM, import_discord_player8.QueryType.SPOTIFY_PLAYLIST, import_discord_player8.QueryType.SPOTIFY_SONG].some((t) => t === type);
  }
  async handle(query, context) {
    switch (context.type) {
